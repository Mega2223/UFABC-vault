...
\end{algorithm}
```
todavia para a maioria dos casos reais, $\large |N| \gg \large |M|$, considerando uma lista indexável, em casos onde o número de possíveis chaves é muito superior ao tamanho do conjunto de chaves, a alocação da tabela pode demandar muito espaço.
## Hash Table
