...
Um circuito sequencial é um circuito que faz decisões baseados em um determinado estado, ou seja, é um [[circuito combinatório]] que usa de algum componente de memória para calcular a sua saída. Normalmente é alguma sequência de [[Flip Flops e Latches|flip-flops]].
