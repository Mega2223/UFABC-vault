...
Nos protocolos [[Modelo TCP-IP|TCP/IP]] e [[Arquitetura de Rede#Modelo OSI|OSI]] a camada de enlace é a [[Arquitetura de Rede#Camada|camada]] responsável pela comunicação entre a [[Camada de Rede]][^1] e as demais camadas, é a camada de enlace que é responsável pelo fluxo de dados e a correção de erros de transmissão causados no [[Computação/Redes de Computador/Camada Física|meio físico]]. A camada de enlace têm a função de tomar dados da camada de rede e os encapsular em quadros para a transmissão.
...
É o processo de codificação de dados em quadros para a [[Computação/Redes de Computador/Camada Física]].
### Cabeçalho
