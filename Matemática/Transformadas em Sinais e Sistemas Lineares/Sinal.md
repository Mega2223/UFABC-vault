...
## Periodicidade 
Um sinal $\large x(t)$ é periódico se existe alguma constante $\large t_0 \gt0$ tal que
$$\large x(t) = x(t+t_0) \forall t\in\mathbb R$$
O menor $\large t_0$ que satisfaz a equação é chamado de período fundamental. Qualquer escalar natural de $\large t_0$ também satisfaz essa equação.

## Frequência
A frequência de um [[#Periodicidade|sinal periódico]] é dada em função de seu período fundamental
$$\large f_0:= \frac 1 {t_0}$$
Para sinais aperiódicos, se usa a convenção $\large f_0 = \infty$.
