...
Um [[Categoria#Isomorfismo e Inversão|isomorfismo]] entre espaços vetoriais é uma [[transformação linear]] [[Função#Injetividade e Sobrejetividade|bijetora]], ou seja, invertível. Temos que se $\large T^{-1}$ existe, $\large T^{-1}$ também é uma transformação linear. Espaços de [[Matemática/Álgebra Linear/Combinação Linear#Dimensão|dimensões diferentes]] nunca são isomórficos entre si.
## Atributos
### Núcleo
